...
public class TabLayoutPanel extends ResizeComposite implements HasWidgets,
  ...
  //XXX: const -> variable
  protected String contentStyle = "gwt-TabLayoutPanelContent";
   ...
   */
  //XXX: refactored to support custom container
  public TabLayoutPanel(double barHeight, Unit barUnit) {
	  this();
	  initTabContent(createPanel(barHeight, barUnit));
  }
  
  protected TabLayoutPanel() {
  }
  
  public TabLayoutPanel(Panel panel) {
	  this();
	  initTabContent(panel);
  }
...
private Panel createPanel(double barHeight, Unit barUnit) {
  ...
  public boolean remove(int index) {
    ...
    child.removeStyleName(contentStyle);
  ...
  public void setTabText(int index, String text) {
    checkIndex(index);
    if (tabs.get(index).getWidget() instanceof HasText) {
    	((HasText)tabs.get(index).getWidget()).setText(text);
    	return;
    }
  ...
  //XXX: private -> protected
  protected void insert(final Widget child, Tab tab, int beforeIndex) {
    ...
    child.addStyleName(contentStyle);
