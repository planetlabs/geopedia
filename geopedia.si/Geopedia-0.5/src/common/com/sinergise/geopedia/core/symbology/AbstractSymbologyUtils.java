...
public abstract class AbstractSymbologyUtils {
	...
	protected String toJavascript (FillSymbolizer symbolizer) {
		...
		jsBuffer.append("fill: 0x"+Integer.toHexString(symbolizer.getFill().getRGB())+",");
		jsBuffer.append("fillBackground: 0x"+Integer.toHexString(symbolizer.getFillBackground().getRGB())+",");
	...
	protected String toJavascript (LineSymbolizer symbolizer) {		
		...
		jsBuffer.append("stroke: 0x"+Integer.toHexString(symbolizer.getStroke().getRGB())+",");
