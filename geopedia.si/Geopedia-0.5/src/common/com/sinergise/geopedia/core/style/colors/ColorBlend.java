...
public final class ColorBlend extends ColorSpec
{
	...
	public ColorBlend(NumberSpec number, ColorSpec[] colors, NumberSpec[] limits)
	{
		if (colors != null && limits != null && colors.length != limits.length)
	...
	public Object clone()
	{
		...
		return new ColorBlend(number, colors, limits);
	}
}
