...
{
	/**
	 * Returns a Map containing ElementDescriptors for all elements in the XHTML
	 * strict DTD.
	 */
	public HashMap<String, ElementDescriptor> build() throws Exception
	{
		DOMParser parser = new DOMParser();

		URL dtdURL = getClass().getClassLoader()
		                .getResource("org/outerj/daisy/htmlcleaner/xhtml1-transitional-modded.dtd");
	...
	{
		List<Element> foundElements = new ArrayList<Element>();
		TreeWalker walker = ((DocumentTraversal) element.getOwnerDocument()).createTreeWalker(element,
