...
public class SaxBuffer implements ContentHandler, LexicalHandler, Serializable
{
	 ...
	 */
	protected ArrayList<SaxBit> saxbits = new ArrayList<SaxBit>();
	...
	public final ArrayList<SaxBit> getBits()
	{
		return saxbits;
	}
	...
	public static final class StartDTD implements SaxBit, Serializable
	{
		...
		{
			writer
			                .write("[StartDTD] name=" + name + ",publicId=" + publicId + ",systemId="
			                                + systemId + "\n");
		}
	}
	...
	public static final class StartElement implements SaxBit, Serializable
	{
		...
		public void dump(Writer writer) throws IOException
		{
			writer.write("[StartElement] namespaceURI=" + namespaceURI + ",localName=" + localName
			                + ",qName=" + qName + "\n");
			for (int i = 0; i < attrs.getLength(); i++) {
				writer.write("      [Attribute] namespaceURI=" + attrs.getURI(i) + ",localName="
				                + attrs.getLocalName(i) + ",qName=" + attrs.getQName(i) + ",type="
				                + attrs.getType(i) + ",value=" + attrs.getValue(i) + "\n");
			}
		}
	}
	...
	public static final class EndElement implements SaxBit, Serializable
	{
		...
		public void dump(Writer writer) throws IOException
		{
			writer.write("[EndElement] namespaceURI=" + namespaceURI + ",localName=" + localName + ",qName="
			                + qName + "\n");
		}
	}
