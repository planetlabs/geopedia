 ...
 * upload data arrives via a single InputStream, each FilePart's contents must
 * be read before moving onto the next part. Don't try to store a FilePart
 * object for later processing because by then their content will have been
 * passed by.
 * 
...
public class FilePart extends Part
{
	 ...
	 */
	FilePart(String name, ServletInputStream in, String boundary, String contentType, String fileName,
	                String filePath)
	{
		super(name);
