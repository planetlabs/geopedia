...
public class SymbolColorFromField extends ColorSpec
{
	public UserFieldPath field;

	public SymbolColorFromField(UserFieldPath fieldPath)
    {
	...
	public void toStringJS(StringBuffer sb) {
		throw new RuntimeException(SymbolColorFromField.class+" not supported");		
	}
	public void toString(StringBuffer sb)
    {
		field.toString(sb);
		sb.append(".symbolStyle.color");
    }
}
