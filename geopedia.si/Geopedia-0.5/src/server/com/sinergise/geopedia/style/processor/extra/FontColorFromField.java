...
public class FontColorFromField extends ColorSpec
{
	public UserFieldPath field;

	public FontColorFromField(UserFieldPath fieldPath)
    {
	...
	public void toStringJS(StringBuffer sb) {
		throw new RuntimeException(FontColorFromField.class+" not supported");		
	}
