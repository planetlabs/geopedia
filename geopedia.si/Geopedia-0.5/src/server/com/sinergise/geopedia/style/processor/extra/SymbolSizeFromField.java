...
public class SymbolSizeFromField extends NumberSpec
{
	public UserFieldPath field;

	public SymbolSizeFromField(UserFieldPath fieldPath)
    {
	...
	public void toStringJS(StringBuffer sb) {
		throw new RuntimeException(SymbolSizeFromField.class+" not supported");		
	}
