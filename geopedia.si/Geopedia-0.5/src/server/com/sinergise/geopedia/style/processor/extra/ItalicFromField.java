...
public class ItalicFromField extends BooleanSpec
{
	public UserFieldPath field;

	public ItalicFromField(UserFieldPath fieldPath)
    {
	...
	public void toStringJS(StringBuffer sb) {
		throw new RuntimeException(ItalicFromField.class+" not supported");		
	}
