...
public class FillFgColorFromField extends ColorSpec
{
	public UserFieldPath field;

	public FillFgColorFromField(UserFieldPath fieldPath)
    {
	...
	public void toStringJS(StringBuffer sb) {
		throw new RuntimeException(FillFgColorFromField.class+" not supported");		
	}
	
	public void toString(StringBuffer sb)
    {
		field.toString(sb);
		sb.append(".fillStyle.fgColor");
    }
}
